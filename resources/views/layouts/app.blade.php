...
<aside id="sidebar"
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        @elseif(auth()->user()->role === 'guru_wali')
        {{-- ── GURU WALI MENU ── --}}
        <div class="pt-3 pb-1 px-3">
            <p class="text-blue-300 text-xs font-semibold uppercase tracking-wider">Bimbingan Saya</p>
        </div>

        <a href="{{ route('guru_wali.assignment') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-blue-100 hover:bg-white/10 transition
                  {{ request()->routeIs('guru_wali.assignment*') ? 'nav-active' : '' }}">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('guru_wali.siswa.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-blue-100 hover:bg-white/10 transition
                  {{ request()->routeIs('guru_wali.siswa.*') ? 'nav-active' : '' }}">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">

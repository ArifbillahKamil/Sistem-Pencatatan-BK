...
<div class="mb-6 flex items-center gap-3">
    ...
    <div>
        <h1 class="text-2xl font-bold text-slate-800">Tambah Jenis Pelanggaran</h1>
        <p class="text-slate-500 text-sm">Definisikan jenis pelanggaran baru beserta bobotnya</p>
    </div>
</div>

<div class="max-w-xl">
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
        <form action="{{ route('jenis-pelanggaran.store') }}" method="POST" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <textarea id="deskripsi" name="deskripsi" rows="3"
                          ...
                          class="w-full px-4 py-2.5 border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white resize-none">{{ old('deskripsi') }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" id="bobot_poin" name="bobot_poin"
                           value="{{ old('bobot_poin') }}" min="1" max="100"
                           placeholder="1 – 100"
                           class="w-full px-4 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-400
            ...
            <div class="bg-blue-50 border border-blue-100 rounded-xl p-3">
                <p class="text-xs text-blue-700">
                    <span class="font-semibold">Panduan bobot poin:</span>
                    Ringan: 1–10 · Sedang: 11–25 · Berat: 26–100
                </p>
            </div>

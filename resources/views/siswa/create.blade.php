...
<div class="mb-6 flex items-center gap-3">
    ...
    <div>
        ...
        <p class="text-slate-500 text-sm">Isi form di bawah untuk mendaftarkan siswa baru</p>
    </div>
</div>
        ...
        <form action="{{ route('siswa.store') }}" method="POST" class="space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div class="sm:col-span-2">
                    <label for="nama_siswa" class="block text-sm font-medium text-slate-700 mb-1.5">
                ...
                {{-- NISN --}}
                <div>
                    <label for="nisn" class="block text-sm font-medium text-slate-700 mb-1.5">
                        NISN <span class="text-red-500">*</span>
                    </label>
                    <input type="text" id="nisn" name="nisn"
                           value="{{ old('nisn') }}" placeholder="10 digit angka" maxlength="10"
                ...
                {{-- Jenis Kelamin --}}
                <div>
                    <label for="jenis_kelamin" class="block text-sm font-medium text-slate-700 mb-1.5">
                ...
                {{-- Kelas --}}
                <div>
                    <label for="id_kelas" class="block text-sm font-medium text-slate-700 mb-1.5">
                ...
                {{-- Tanggal Lahir --}}
                <div>
                    <label for="tanggal_lahir" class="block text-sm font-medium text-slate-700 mb-1.5">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea id="alamat" name="alamat" rows="3" placeholder="Alamat lengkap siswa"
                              class="w-full px-4 py-2.5 border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white resize-none">{{ old('alamat') }}</textarea>
                </div>
            </div>
